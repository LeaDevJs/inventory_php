...
if(isset($busqueda)&& $busqueda!=""){
    ...
    usuario_usuario LIKE '%$busqueda%'OR usuario_email LIKE '%$busqueda%') )ORDER BY
...
//fetchAll se usa cuando es mas de un registro
...
if($total>=1 && $pagina<=$Npaginas){
    $tabla.='
    <p class="has-text-right">Mostrando usuarios <strong>'.$pag_inicio.'</strong> al <strong>'.$pag_final.'</strong>
     de un <strong>total de '.$total.'</strong></p>
    ';
}
$conexion=null;
echo $tabla;
